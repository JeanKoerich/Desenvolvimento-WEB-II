                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('tipoContato.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="descricao" id="descricao" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        </div>
